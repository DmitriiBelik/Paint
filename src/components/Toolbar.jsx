...
const Toolbar = () => {
    ...
    return(
        <div className="toolbar">
            ...
            <button className="toolbar_btn circle" onClick={() => toolState.setTool(new Circle(canvasState.canvas))}></button>
            <button className="toolbar_btn eraser" onClick={() => toolState.setTool(new Eraser(canvasState.canvas))}></button>
            <button className="toolbar_btn line" onClick={() => toolState.setTool(new Line(canvasState.canvas))}></button>
